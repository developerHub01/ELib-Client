...
const Countdown = () => {
  ...
  return (
    <section className="w-full py-14 bg-white dark:bg-gray-900 text-gray-950 dark:text-white" ref={sectionRef}>
      <div className="w-[90%] max-w-6xl mx-auto grid sm:grid-cols-2 gap-x-5 gap-y-12">
